...
theme.custom.p <- theme(plot.background = element_rect(fill = NA),
                        ...
                        panel.grid.major.y = element_line(linetype = "dashed", colour = alpha("grey", 0.5), linewidth = 1), 
                        panel.grid.minor.y = element_blank(),
                        panel.grid.major.x = element_line(linetype = "dashed", colour = alpha("grey", 0.5), linewidth = 1), 
